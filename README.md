...
Wiring, porting notes, and pin config are in [Getting started](GETTING_STARTED.md#hardware--wiring). The board is also available as a [custom PCB](pcb/README.md).

## Build & flash

1. Install [PlatformIO](https://platformio.org/).
2. Build and upload: `pio run -t upload`, then press the board's reset button.
