...
// The category bits (BIT_STOCKS/WEATHER/CLOCK), MASK_ALL, and the
// MASK_NONE_REQUEST parser sentinel live in logic.h — host-tested alongside
// parseModePayload().
...
// usEasternInDst() (US Eastern DST test for a UTC tm) lives in logic.h/.cpp
// (host-tested).
